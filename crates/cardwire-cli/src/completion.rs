...
# config <action>
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'auto-apply-gpu-state' -d 'Get or set AutoApplyGpuState'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'experimental-nvidia-block' -d 'Get or set ExperimentalNvidiaBlock'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'battery-auto-switch' -d 'Get or set BatteryAutoSwitch'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'battery-auto-switch-mode' -d 'Get or set BatteryAutoSwitchMode'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'external-display-auto-switch' -d 'Get or set automatic Hybrid mode for dGPU-owned external displays'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'external-display-auto-switch-mode' -d 'Get or set the mode restored after disconnect'
complete -c cardwire -f -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from auto-apply-gpu-state experimental-nvidia-block battery-auto-switch battery-auto-switch-mode external-display-auto-switch external-display-auto-switch-mode save' -a 'save' -d 'Save current configuration to file'
...
complete -c cardwire -f -n '__fish_seen_subcommand_from external-display-auto-switch-mode; and test (count (commandline -opc)) -eq 3' -a "integrated\t'Integrated GPU only' hybrid\t'Hybrid mode' manual\t'Manual mode' smart\t'Smart mode'"
